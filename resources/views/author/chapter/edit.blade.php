...
<div class="ch">
    ...
    <div class="fcard">
        <div class="fcard-head">
            <div class="fcard-title">📝 Edit Informasi Chapter</div>
        </div>
            ...
            <form action="{{ route('author.chapter.update', [$novel->id, $chapter->id]) }}" method="POST">
                ...
                <div class="f-2col">
                    <div class="f-group">
                        ...
                        <input type="number" id="urutan" name="urutan" min="1"
                               value="{{ old('urutan', $chapter->urutan) }}"
                    ...
                    <div class="f-group">
                        ...
                        <input type="text" id="title" name="title"
                               value="{{ old('title', $chapter->judul_chapter) }}"
                ...
                <div class="f-group">
                    ...
                    <textarea id="content" name="content" rows="14"
                              ...
                              required>{{ old('content', $chapter->isi) }}</textarea>
