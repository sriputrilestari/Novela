...
@section('content')
    ...
    <style>
        ...
        *::after {
        ...
        .topbar-avatar:hover .avatar-cam-overlay {
            opacity: 1;
        }
        ...
        .profile-card:hover {
            box-shadow: 0 8px 32px rgba(24, 25, 42, .09);
        }
    ...
    <div class="profile-wrap">
        ...
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div class="topbar-avatar" id="topbarAvatar" onclick="document.getElementById('photoFileInput').click()"
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('author.profile.update') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="upload-zone" onclick="document.getElementById('photoFileInput').click()">
                            ...
                            <input type="file" name="photo" id="photoFileInput" accept="image/*" style="display:none"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="bio" id="bioInput" rows="4"
