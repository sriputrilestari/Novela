...
.btn {
    ...
    text-decoration:none;transition:.2s;cursor:pointer;white-space:nowrap;
}
...
.alert-pending strong { color:#7a5008; }
...
.alert-pending .btn-review:hover { background:#d4922a;color:#fff;transform:translateY(-1px); }
...
.scard {
    ...
    box-shadow:var(--shadow);transition:.22s;cursor:default;
}
...
.pill-blue  { background:var(--blue-lt);color:#2d48e0; }
.pill-green { background:var(--green-lt);color:#00a88a; }
.pill-amber { background:var(--amber-lt);color:#b07010; }
...
.status-item {
    ...
    background:#f8f9fe;border:1px solid var(--line);
...
.tbl thead th {
    ...
    background:#f8f9fe;border-bottom:1px solid var(--line);
    font-family:'Plus Jakarta Sans',sans-serif;
}
.tbl tbody td {
    padding:13px 20px;border-bottom:1px solid #f2f4fb;
...
.tag      { border-radius:99px;padding:3px 10px;font-size:11px;font-weight:700;white-space:nowrap; }
...
.btn-action {
    ...
    font-size:13px;transition:.15s;text-decoration:none;
}
.btn-action:hover { filter:brightness(.88);transform:translateY(-1px); }
.btn-action.approve { background:var(--green-lt);color:#00a08a; }
.btn-action.reject  { background:var(--red-lt);color:var(--red); }
.btn-action.detail  { background:var(--blue-lt);color:var(--blue); }

/* ════ DONUT ════ */
.donut-wrap { padding:20px 24px 24px;display:flex;flex-direction:column;align-items:center; }
.donut-pie  { position:relative;height:200px;width:100%; }
.chart-legend { display:flex;flex-direction:column;gap:9px;margin-top:16px;width:100%; }
.legend-item  { display:flex;align-items:center;gap:9px;font-size:13px; }
.legend-dot   { width:10px;height:10px;border-radius:3px;flex-shrink:0; }
.legend-label { color:var(--ink-3);flex:1; }
...
<div class="dash">
    ...
    <div class="stats a2">
        ...
        <div class="scard">
            ...
            <div class="scard-track">
                <div class="scard-fill" style="background:var(--green)" data-p="{{ min(100,$totalAuthor*10) }}"></div>
            </div>
        </div>
        ...
        <div class="scard">
            ...
            <div class="scard-track">
                <div class="scard-fill" style="background:var(--purple)" data-p="{{ min(100,$totalReader*10) }}"></div>
            </div>
        </div>
        ...
        <div class="col-l">
            <div id="pending" class="box">
                <div class="box-head">
                    ...
                    @if($novelPending > 0)
                    <span style="background:var(--amber-lt);color:#b07010;border:1px solid rgba(241,168,61,.2);font-size:11px;font-weight:700;padding:4px 10px;border-radius:99px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-group">
                                    <a href="#" class="btn-action approve" title="Setujui">✓</a>
                                    <a href="#" class="btn-action reject"  title="Tolak">✕</a>
                                    <a href="#" class="btn-action detail"  title="Detail">◉</a>
                                </div>
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="4" style="text-align:center;padding:36px;color:var(--ink-3);font-size:13px;">
